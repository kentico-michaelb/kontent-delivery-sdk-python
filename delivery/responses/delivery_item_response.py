...
class DeliveryItemResponse(BaseApiResponse):
    ...
    def cast_to_content_item(self, delivery_item_response, custom_inline_resolver, use_inline_item_resolver):
        delivery_item_response = delivery_item_response.content
        content_item = ContentItem(delivery_item_response['item'], custom_inline_resolver, use_inline_item_resolver, delivery_item_response['modular_content'])
        return content_item